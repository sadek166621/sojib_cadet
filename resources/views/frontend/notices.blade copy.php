...
<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-3541" class="nav_navyblue menu-item menu-item-type-post_type menu-item-object-page  menu-item-3541 nav-item"><a href="{{ route('result.list') }}" class="nav-link"><span class="menu-text">Results</span><div class="mobile-nav"></div></a>
<ul class="dropdown-menu"  role="menu">
</ul>
</li>
